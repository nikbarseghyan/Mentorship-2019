 ...
 * @hoisting Դա Js 'interprete'-ի աշխատանքի այն ֆազան է երբ հանդիպելով հատուկ բառերին(@const @let @var @function ... )
    ...
    - Որպիսզի օպերացիոն համակարգը նախապես հատկացնի ծրագրի աշխատանքի համար համապատասխան հիշողություն այդ թվում ռեզերվային կամ բուֆերային @swap .
 *@use_stract hoisting տեղի չի ունենում․
