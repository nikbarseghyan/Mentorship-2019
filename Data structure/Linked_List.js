/**
 * @Linked_List դա @class որը ռեալիզացնում է @List և @Qeque ինտերֆեյսերը։ Դա ապահովում է երկողմանի կապ էլեմենտների միջև(next & prev link)։
 ...
 * 
 * @Linked_List տարրերի հաջորդականություն է: Իր ամենապարզ տեսքով ցուցակը կարող է իրականացվե(հանդես գալ)լ որպես զանգված: 
 *      Այնուամենայնիվ, «Linked List» տերմինը սովորաբար վերաբերում է կապված ցուցակին։
 ...
 * 
 * @Linked_List -ը իտարբերություն @Array -ի կիրառվում է՝ ավելի շատ փոփոխություններ իրականացնելու համար և քիչ դիմել պարունակվող տարրերին։
 * 
 * @LinkedListNode
 * @LinkedList
 * @SinglyList 
